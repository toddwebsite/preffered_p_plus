...
class LoginView(FormView):
    ...
    template_name = "login_form.html" #"account/login.html"
...
class LogoutView(TemplateResponseMixin, View):
    ...
    template_name = "form.html" #"account/logout.html"
    redirect_field_name = "next"
...
class SettingsView(LoginRequiredMixin, FormView):
    ...
    template_name = "form.html" #"account/settings.html"
    ...
    def get_initial(self):
        ...
        initial["bio"] = self.request.user.account.bio
        initial["agent_image"] = self.request.user.account.agent_image
        initial["phone_number"] = self.request.user.account.phone_number
        initial["alt_phone_number"] = self.request.user.account.alt_phone_number
        initial["linkd"] = self.request.user.account.linkd
        initial["fb"] = self.request.user.account.fb
        initial["insta"] = self.request.user.account.insta
        initial["twit"] = self.request.user.account.twit
        initial["snap"] = self.request.user.account.snap
        initial["pin"] = self.request.user.account.pin
        initial["goog"] = self.request.user.account.goog
        initial["utube"] = self.request.user.account.utube
        initial["mtup"] = self.request.user.account.mtup
        return initial
    ...
    def form_valid(self, form):
        ...
        # return redirect(self.get_success_url())
        return redirect("agent_detail", self.request.user.account.slug)
    ...
    def update_account(self, form):
        ...
        fields["bio"] = form.cleaned_data["bio"]
        fields["agent_image"] = form.cleaned_data["agent_image"]
        fields["phone_number"] = form.cleaned_data["phone_number"]
        fields["alt_phone_number"] = form.cleaned_data["alt_phone_number"]
        fields["linkd"] = form.cleaned_data["linkd"]
        fields["fb"] = form.cleaned_data["fb"]
        fields["insta"] = form.cleaned_data["insta"]
        fields["twit"] = form.cleaned_data["twit"]
        fields["snap"] = form.cleaned_data["snap"]
        fields["pin"] = form.cleaned_data["pin"]
        fields["goog"] = form.cleaned_data["goog"]
        fields["utube"] = form.cleaned_data["utube"]
        fields["mtup"] = form.cleaned_data["mtup"]
        if fields:
