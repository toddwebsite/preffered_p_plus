...
class Account(models.Model):
    ...
    bio = models.TextField(_('my bio'), max_length=4000, null=True, blank=True)
    # image = models.OneToOneField(ImageSet, null=True, blank=True, on_delete=models.CASCADE)
    agent_image = VersatileImageField(
        'Agent Image',
        null=True, blank=True,
        upload_to='images/agents/',
        width_field='width',
        height_field='height'
    )
    ...
    alt_phone_number = models.CharField(_('alternate phone'), max_length=12, null=True, blank=True)
    linkd = models.CharField(_('LinkedIn'), max_length=30, null=True, blank=True)
    fb = models.CharField(_('Facebook'), max_length=30, null=True, blank=True)
    insta = models.CharField(_('Instagram'), max_length=30, null=True, blank=True)
    twit = models.CharField(_('Twitter'), max_length=30, null=True, blank=True)
    snap = models.CharField(_('Snap Chat'), max_length=30, null=True, blank=True)
    pin = models.CharField(_('Pintrest'), max_length=30, null=True, blank=True)
    goog = models.CharField(_('Google+'), max_length=30, null=True, blank=True)
    utube = models.CharField(_('YouTube'), max_length=30, null=True, blank=True)
    mtup = models.CharField(_('Meetup'), max_length=30, null=True, blank=True)
...
def pre_save_agent(sender, instance, *args, **kwargs):
    slug = "{} {} {}".format(
...
pre_save.connect(pre_save_agent, sender=Account)
